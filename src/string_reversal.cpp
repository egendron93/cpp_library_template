...
bool IsPrintableAsciiCharacters(const std::string& s) {
  ...
  constexpr auto printable_ascii_chars =
      std::array<char, kPrintableAsciiCount>{GetPrintableAsciiCharacters()};
  const auto ascii_compare =
      std::string{printable_ascii_chars.begin(), printable_ascii_chars.end()};
